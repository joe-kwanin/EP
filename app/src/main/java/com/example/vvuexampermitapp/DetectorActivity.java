...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    idtextview = findViewById(R.id.name);
    ...
    fab.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (detected && goon){
          ...
          Query query = FirebaseDatabase.getInstance().getReference("student").orderByChild("studentid").equalTo(idtextview.getText().toString());
          query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
              ...
              if (studentClass!=null){
                ...
                View view = (LinearLayout)findViewById(R.id.lin);
                Toast.makeText(getApplicationContext(),"No user for "+ idtextview.getText().toString(),Toast.LENGTH_SHORT).show();
              }
            }
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    try {
      ...
      detector =
              com.example.vvuexampermitapp.TFLiteObjectDetectionAPIModel.create(
                      getAssets(),
    ...
    faceDetector
            ...
            .addOnSuccessListener(new OnSuccessListener<List<Face>>() {
              ...
              public void onSuccess(List<Face> faces) {
                if (faces.size() == 0) {
                  sname = updateResults(currTimestamp, new LinkedList<>());
                  return;
                }
                runInBackground(
                        new Runnable() {
...
//          knownFaces.put(name, rec);
  ...
  private String updateResults(long currTimestamp, final List<SimilarityClassifier.Recognition> mappedRecognitions) {
    String studentid;
    ...
    if (mappedRecognitions.size() > 0) {
       ...
       if (rec.getExtra() != null) {
          studentid=showAddFaceDialog(rec);
          return studentid;
       }
  ...
  private String onFacesDetected(long currTimestamp, List<Face> faces, boolean add) {
...
//    }
    ...
    String name = updateResults(currTimestamp, mappedRecognitions);
